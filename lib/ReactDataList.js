...
var _stylesReactDatalistStyl = require('./styles/react-datalist.styl');

var _stylesReactDatalistStyl2 = _interopRequireDefault(_stylesReactDatalistStyl);
    ...
    _createClass(ReactDataList, [{
        ...
        value: function render() {
            ...
            var layoutstyle = this.props.includeLayoutStyle ? _react2['default'].createElement(
                'style',
                null,
                _stylesReactDatalistStyl2['default']
            ) : null;
        ...
        value: function componentDidMount() {
            ...
            setTimeout((function () {
                ...
                var _input = _react2['default'].findDOMNode(this.refs.theInput);
                var _datalist = _react2['default'].findDOMNode(this.refs.theDatalist);
